...
const begin3 = process.hrtime(); // [number1, number2]
const res3 = fn();
const end3 = process.hrtime(begin3); //hrtime - hrtime(begin3)
const diff3 = end3[0] * 1e9 + end3[1]; //nanoseconds
const sec3 = diff3 / 1e9; //second.s...
